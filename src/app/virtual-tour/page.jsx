...
export default function VirtualTourPage() {
  ...
  return (
    <main className="relative isolate min-h-screen overflow-hidden px-3 pb-8 pt-24 md:px-6 md:pt-28">
      {/* Background photo only */}
    ...
    {/* General overlay */}
    <div className="absolute inset-0 bg-gradient-to-b from-black/55 via-black/20 to-black/35" />

    {/* Smooth transition into footer */}
    <div className="absolute inset-x-0 bottom-0 h-32 bg-gradient-to-b from-transparent via-black/30 to-black/75" />
    </div>

      {/* Original white Virtual Tour content */}
